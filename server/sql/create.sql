...
----------------------------
\copy Cities(city_id, city_name, city_state, zip_code) FROM '/Users/wenlo/Documents/School Work/CS 166/CS166/data/Cities.csv' WITH DELIMITER ',';

\copy Cinemas(cid, city_id, cname, tnum) FROM '/Users/wenlo/Documents/School Work/CS 166/CS166/data/Cinemas.csv' WITH DELIMITER ',';

\copy Theaters(tid, cid, tname, tseats) FROM '/Users/wenlo/Documents/School Work/CS 166/CS166/data/Theaters.csv' WITH DELIMITER ',';

\copy CinemaSeats(csid, tid, sno, stype) FROM '/Users/wenlo/Documents/School Work/CS 166/CS166/data/CinemaSeats.csv' WITH DELIMITER ',';

\copy Movies(mvid, title, rdate, country, description, duration, lang, genre) FROM '/Users/wenlo/Documents/School Work/CS 166/CS166/data/Movies.csv' WITH DELIMITER ',';

\copy Users(email, lname, fname, phone, pwd) FROM '/Users/wenlo/Documents/School Work/CS 166/CS166/data/Users.csv' WITH DELIMITER ',';

\copy Shows(sid, mvid, sdate, sttime, edtime) FROM '/Users/wenlo/Documents/School Work/CS 166/CS166/data/Shows.csv' WITH DELIMITER ',';

\copy Bookings(bid, status, bdatetime, seats, sid, email) FROM '/Users/wenlo/Documents/School Work/CS 166/CS166/data/Bookings.csv' WITH DELIMITER ',';

\copy Payments(pid, bid, pmethod, pdatetime, amount, trid) FROM '/Users/wenlo/Documents/School Work/CS 166/CS166/data/Payments.csv' WITH DELIMITER ',';

\copy ShowSeats(ssid, sid, csid, bid, price) FROM '/Users/wenlo/Documents/School Work/CS 166/CS166/data/ShowSeats.csv' WITH DELIMITER ',' NULL AS '';

\copy Plays(sid, tid) FROM '/Users/wenlo/Documents/School Work/CS 166/CS166/data/Plays.csv' WITH DELIMITER ',';
